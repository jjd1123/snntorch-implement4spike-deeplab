...
traindata = augvocDataset("/mnt/xlancefs/home/zsx66/dataset/snn/data", transform=img_transform,target_transform=tar_transform)
...
for epoch in range(1,num_epochs+1):
    ...
    with torch.no_grad():
        ...
        for i, (datas, targets) in enumerate(tqdm(testloader)):
            ...
            # spk_rec = F.interpolate(input=spk_rec,scale_factor=4,mode = "bilinear",align_corners=True)
